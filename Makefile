...
rasm3: rasm3.o $(sUC) $(sLC) String_Length.o String_indexOf_2.o String_indexOf_1.o String_indexOf_3.o String_lastIndexOf_1.o String_lastIndexOf_2.o String_lastIndexOf_3.o
	ld -o rasm3 rasm3.o String_Length.o String_indexOf_3.o String_indexOf_1.o String_indexOf_2.o String_lastIndexOf_1.o String_lastIndexOf_2.o String_lastIndexOf_3.o $(sUC) $(sLC) $(LL) $(lib1)
